...
# Since @Graey ( myself) has edited and modded and the orignal author's account is not availlable, this code is of my own. 
...
sleep 0.5
clear
printf "\e[1;92m\n >>>Please tun on internet connection to get correct result<<<\n\n"
printf "\n\e[0m"
